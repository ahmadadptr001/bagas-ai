...
_BTN_MODEL = '[aria-label="Buka pemilih mode, saat ini Pro"]'   # bar ATAS
...
class GeminiConnector(WebConnector):
    ...
    # URL percakapan: https://gemini.google.com/app/{id} (terverifikasi) -> lanjut
    ...
    input_selector = "div.single-line-format"
    ...
    send_button_selector = 'button, [aria-label="Kirim pesan"]'
    ...
    file_input_selector = '[data-test-id="uploader-images-files-button-advanced"]'
    ...
    web_actions = (
        ("3.5 Flash-Lite", ("3.5 Flash-Lite",),
         "Jawaban tercepat", _BTN_MODEL),
        ("3.6 Flash", ("3.6 Flash",),
         "Bantuan serbaguna", _BTN_MODEL),
        ("3.1 Pro", ("3.1 Pro",),
         "Matematika dan coding tingkat lanjut", _BTN_MODEL),
    )
